...
const filterResultArr = ["A to Z", "Z to A", "Cheap", "Expensive", "Popular", "Not popular", "Show all"]
...
//             <option value="${arr[5]}">${arr[5]}</option>
//             <option value="${arr[6]}">${arr[6]}</option>
//             <option value="${arr[7]}">${arr[7]}</option>
//             <option value="${arr[8]}">${arr[8]}</option>
//             <option value="${arr[9]}">${arr[9]}</option>
//             <option value="${arr[10]}">${arr[10]}</option>
...
function createMarcupCategory() {
  if(!arrCategories.length) {
    
  }
}

filtersSection.innerHTML = createMarcupCategory(arrCategories);
