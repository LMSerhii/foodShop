...
`,S=`
          ...
          </div>`,C=({name:t,desc:e,img:s,category:a,price:o,size:r,is10PercentOff:l,popularity:m})=>`
            <div class="modal">
            <div class="container">
                  ...
                  <div class="modal-product-text-box">
                    ...
                    <ul class="modal-product-list">
                      ...
                      <li class="modal-produt-item">Popularity:
                        <span class="list-variables">${m}</span>
                      </li>
                    </ul>
                    <div class="scroll">
...
`;async function O(t){try{return(await n({url:`${i.BASE_URL}/products`,method:"GET",header:{"Content-Type":"aplication/json"},params:t})).data}catch(e){return e}}async function j(t){try{return(await n({url:`${i.BASE_URL}/products/${t}`,method:"GET",header:{"Content-Type":"aplication/json"}})).data}catch(e){return e}}async function A(t){try{let e=null;return t&&(e={limit:t}),(await n({url:`${i.BASE_URL}/products/popular`,method:"GET",header:{"Content-Type":"aplication/json"},params:e})).data}catch(e){return e}}async function B(){try{return(await n({url:`${i.BASE_URL}/products/discount`,method:"GET",header:{"Content-Type":"aplication/json"}})).data}catch(t){return t}}async function F(){try{return(await n({url:`${i.BASE_URL}/products/categories`,method:"GET",header:{"Content-Type":"aplication/json"}})).data}catch(t){return t}}async function R(t){try{const e=await n({url:"https://food-boutique.b.goit.study/api/orders",method:"POST",headers:{"Content-Type":"application/json"},data:t}),s=document.querySelector(".order-form"),a=v(i.LOCAL_CART_KEY)??[],o=E(a);u(s,o)}catch{const s=document.querySelector(".order-form"),a=w();u(s,a)}}async function L(t){try{return(await n({url:`${i.BASE_URL}/subscription`,method:"POST",headers:{"Content-Type":"application/json"},data:{email:t}})).status}catch(e){return e.response.status}}const k=()=>{d.emailForm.addEventListener("submit",$)},$=t=>{t.preventDefault();const e=d.emailInput.value.trim();if(!g(e)){y.warning({title:"Caution",message:"Check your email address"});return}q(e),d.emailForm.reset()};async function q(t){const e=await L(t);switch(e){case 201:u(d.emailForm,f);break;case 409:u(d.emailForm,S);break}return e}export{R as a,c as b,i as c,d,O as e,F as f,j as g,A as h,B as i,k as j,v as l,C as m,$ as o,_ as r,T as s};
//# sourceMappingURL=footer-f055743d.js.map
