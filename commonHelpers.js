import{o as v,h as u,l as n,c as o,s as g,r as C,a as b,b as i}from"./assets/header-11d45d43.js";import{v as f,i as _}from"./assets/vendor-f213eb09.js";const A="/foodShop/assets/yellow_shopping_basket-566aede4.png",r={cartList:document.querySelector(".cart-list"),deleteAll:document.querySelector(".cart-delete-all"),orderBox:document.querySelector(".order-box"),orderForm:document.querySelector(".order-form"),totalSum:document.querySelector(".order-box-total-price-var"),footerForm:document.querySelector(".subscribe-form"),headerCount:document.querySelector("#product-count-header"),cartWrapper:document.querySelector(".cart-wrapper")},h=t=>t.length?t.map(({_id:e,img:s,name:a,category:c,size:l,price:L})=>`<li class="cart-item js-card" data-id="${e}">
